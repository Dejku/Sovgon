...
import { Embed, Emoji, Logger } from './Utilities.js';
        ...
        await Session.find({
            ...
            results.forEach(async session => {
                ...
                if (isNow()) {
                    ...
                    if (THREAD === undefined) return Logger.error("Nie znaleziono odpowiedniego kanału podczas zamykania sesji testowej");
